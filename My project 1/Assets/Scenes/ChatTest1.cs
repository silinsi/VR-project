...
namespace OpenAI
{
    public class ChatTest1 : MonoBehaviour
    {
        ...
        private void Start()
        {
            var message = new ChatMessage{Role = "user", Content =
                    "Act as a scientist in the starship. First instruct me to fold the clothes on the table\n" +
                    "After I finish this, instruct me to cut the fruits" +
